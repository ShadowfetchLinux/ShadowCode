...
![version](https://img.shields.io/badge/version-0.22.1-386c51) ![Rust](https://img.shields.io/badge/runtime-Rust%201.95-orange) ![license](https://img.shields.io/badge/license-MIT-green)
...
Download the `v0.22.1` **x86_64 AppImage**
...
chmod +x ShadowCode_0.22.1_amd64.AppImage
./ShadowCode_0.22.1_amd64.AppImage --appimage-extract-and-run
```
...
cd ShadowCode
./scripts/install-appimage.sh /path/to/ShadowCode_0.22.1_amd64.AppImage
```
